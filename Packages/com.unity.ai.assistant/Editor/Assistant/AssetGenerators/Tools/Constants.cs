...
namespace Unity.AI.Assistant.Editor.Backend.Socket.Tools
{
    static class Constants
    {
        ...
        public const string GenerateAssetFunctionDescription = k_GenerateAssetGeneralDescription + " " + k_GenerateSpriteDescription + " " + k_GenerateCubemapDescription + " " + k_GenerateMaterialDescription + " " + k_GenerateSoundDescription + " " + k_GenerateMeshDescription;
