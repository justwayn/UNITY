...
namespace Unity.AI.Assistant.Editor.Api
{
    ...
    public static partial class AssistantApi
    {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel the asynchronous operation.</param>
        /// <returns></returns>
        internal static async Task PromptThenRunInternal(VisualElement parent, string placeholderPrompt = "", AttachedContext attachedContext = null, AssistantMode assistantMode = AssistantMode.Agent, string resumeConversationId = null, CancellationToken cancellationToken = default)
        {
            if (parent == null)
                throw new ArgumentNullException(nameof(parent), "You must provide a valid parent");

            var parentRect = GetScreenRect(parent);
            await PromptThenRunInternal(parentRect, placeholderPrompt, attachedContext, assistantMode, resumeConversationId, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel the asynchronous operation.</param>
        /// <returns></returns>
        internal static async Task PromptThenRunInternal(Rect parentRect, string placeholderPrompt = "", AttachedContext attachedContext = null, AssistantMode assistantMode = AssistantMode.Agent, string resumeConversationId = null, CancellationToken cancellationToken = default)
        {
